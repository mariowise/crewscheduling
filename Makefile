...
main: build/main.o build/DateTime.o build/TimeInterval.o build/Station.o build/Trip.o build/Service.o build/Reader.o build/ProblemChecks.o build/Phenotype.o build/Genotype.o
...
build/ProblemChecks.o: src/problem/ProblemChecks.cpp
	@ echo "  src/problem/ProblemChecks.cpp"
	@ g++ $(CFLAGS) $(INC_DIRS) src/problem/ProblemChecks.cpp -o build/ProblemChecks.o
